...
//    });
  ...
  .get((req, res) => {
    ...
    var sql="select house_name from manage where PhoneNumber ='" + PhoneNumber+"'";
    var options;
    var optionstring;
...
//    });
  ...
  .post((req, res) => {
    ...
    var sql = "delete from manage where house_name ='" + house_name+"' and PhoneNumber='"+ PhoneNumber+"'";
...
//    });
  ...
  .get((req, res) => {
    ...
    if (PhoneNumber) {
      var sql="select property.PID, property.house_name from property join manage on property.house_name=manage.house_name where PhoneNumber ='" +PhoneNumber+"'";
    }
...
//    });
  ...
  .get((req, res) => {
    ...
    if (PhoneNumber) {
      var sql="select property.house_name from property join manage on property.house_name=manage.house_name where manage.PhoneNumber ='" +PhoneNumber+"'";
    }
    var options;
    var optionstring;
...
//    });
    ...
    if (PhoneNumber) {
      ...
      res.write(`
        ...
        <a href="http://localhost/managermainten?PhoneNumber=${PhoneNumber}"> Back </a>
        </br></br>
        <input type="submit" value="Select" />  
        </form>  
      `);
...
//    res.end();
  ...
  .get((req, res) => {
    ...
    if (OID) {
      sql="select property.house_name from property join own on property.PID = own.PID where own.OID = '" + OID + "'";
    }
...
//    });
  ...
  .get((req, res) => {
    ...
    console.log("Furnitures update select select called"); 
    OID=req.query.OID;
    PhoneNumber=req.query.PhoneNumber;
    //Furniture_name1=req.query.Furniture_name1;
    //Furniture_name2=req.query.Furniture_name2;
    //Furniture_name3=req.query.Furniture_name3;
    //Furniture_name4=req.query.Furniture_name4;
    //Furniture_name5=req.query.Furniture_name5;
    //Furniture_name6=req.query.Furniture_name6;
    //Furniture_name7=req.query.Furniture_name7;
    //Furniture_name8=req.query.Furniture_name8;
    //Furniture_name9=req.query.Furniture_name9;
    //Furniture_name10=req.query.Furniture_name10;
    if (OID) {
      var sql="select property.PID, property.house_name from property join own on property.PID=own.PID where own.OID ='" +OID+"'";
    }
    if (PhoneNumber) {
      var sql="select manage.house_name, PID from manage join property on manage.house_name=property.house_name where PhoneNumber ='" +PhoneNumber+"'";
    }
  ...
  .post((req, res) => {
    ...
    var sql='select Furniture_name1 from Furnitures where PID=  '+mysql.escape(PID);
    connection.query(sql, function(err,result, fields) {
      if (err) throw err;
      if (result.length != 0) {
        //var sql = "update Picture_files set File_name1='" + File_name1 + "',File_name2='" + File_name2+ "',File_name3='" + File_name3+ "',File_name4='" + File_name4+ "',File_name5='" + File_name5+ "',File_name6='" + File_name6+ "',File_name7='" + File_name7+ "',File_name8='" + File_name8+ "',File_name9='" + File_name9+ "',File_name10='" + File_name10  +   "' where PID ='" + PID+"'";
        ...
        var sql = "INSERT INTO Furnitures (PID,Furniture_name1,Furniture_name2,Furniture_name3,Furniture_name4,Furniture_name5,Furniture_name6,Furniture_name7,Furniture_name8,Furniture_name9,Furniture_name10 ) values ('" + PID +"','"+ Furniture_name1+"','"+ Furniture_name2+"','"+ Furniture_name3+"','"+ Furniture_name4+"','"+ Furniture_name5+"','"+ Furniture_name6+"','"+ Furniture_name7+"','"+ Furniture_name8+"','"+ Furniture_name9+"','"+ Furniture_name10 + "')";
        console.log(sql);
        connection.query(sql, (err) =>{
          if (err) {
            console,log(err);  
            ...
            console.log('Furnitures record inserted sucessfully');
            res.send('Furnitures record inserted');
            res.end();
          }
        })
      }  
...
//    });
    ...
    res.write(`
      ...
      <h4> PhoneNumber: ${PhoneNumber} </h4>  
        ...
        <a href="http://localhost/managedelete?PhoneNumber=${PhoneNumber}"> Delete managing property </a>
